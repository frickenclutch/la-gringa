...
(function () {
  ...
  // The book only moves when the view changes (cover / single-page shift).
  // Pointer-driven parallax was removed: it re-composited the 3D book on
  // every mouse move and made the whole menu feel laggy.
